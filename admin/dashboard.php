									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
<?php 
$query1=mysqli_query($con,"SELECT id from tblblooddonars");                       
...
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($totalBloodVolume);?></div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
<?php 
$query11=mysqli_query($con,"SELECT id from tblblooddonated");                       
$regbdd = mysqli_num_rows($query11);
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($regbdd);?></div>
													<div class="stat-panel-title text-uppercase">Total Blood Donated</div>
												</div>
											</div>
											<a href="manage-donordonation.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
