...
$ret=mysqli_query($con,"SELECT * from tblblooddonars where EmailId = '$email'");
if(mysqli_num_rows($ret) > 0 )
{
	$error="This Email Address Already Exist!";
}
else{
    $query = mysqli_query($con,"insert into tblblooddonars(FullName,MobileNumber,EmailId,Gender,Age,BloodGroup,Address,Message,status) value('$fullname','$mobile','$email','$gender','$age','$blodgroup','$address','$message','$status')");
    if($query == True)
    {
